...
This fork extends the original with the latest open-weight models (gpt-oss, Llama 4, Qwen 3-Next, DeepSeek V3.2 / V4, Kimi K2 / K2.7-Code / K3, GLM-5.2 / 5.1 / 4.7-Flash, MiniMax M2.x / M3, Mistral Large 3 / Small 4 / Medium 3.5 / Devstral 2 / Leanstral 1.5, Tencent Hunyuan Hy3, IBM Granite 4.1, Cohere Command A+ / North-Mini-Code, InclusionAI Ring/Ling 2.6 / Ling 3.0 Flash, Xiaomi MiMo V2.5 Pro, Google Gemma 4 12B, NVIDIA Nemotron 3 Ultra, LG EXAONE 4.5, Thinking Machines Inkling) and inference hardware (NVIDIA Rubin R100 / DGX Spark / GB10, NVIDIA RTX PRO 6000 Blackwell, RTX PRO 5000 Blackwell 48/72GB, B300, AMD MI455X / MI355X, …). Weights quantization covers GGUF, GPTQ, AWQ, MLX, FP8 and NVFP4 (FP8 and NVFP4 shown only for models that ship a real build on HuggingFace).

_Last updated by Claude on 2026-08-10._ The model & hardware catalog is refreshed by a scheduled Claude Code routine — see [CLAUDE.md](./CLAUDE.md).
