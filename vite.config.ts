...
// CI sets VITE_BASE=/HardwareEstimator/ when deploying to GitHub Pages (project
// page served from a subpath). Keeping it env-driven means switching to a
// custom domain later is just "drop the env var" — no source change needed.
